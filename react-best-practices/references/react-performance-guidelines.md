...
5. [Re-render Optimization](#5-re-render-optimization) — **MEDIUM**
   - 5.1 [Choose the Right State Tool](#51)
   - 5.2 [Defer State Reads to Usage Point](#52)
   - 5.3 [Extract to Memoized Components](#53)
   - 5.4 [Narrow Effect Dependencies](#54)
   - 5.5 [Subscribe to Derived State](#55)
   - 5.6 [Use Lazy State Initialization](#56)
   - 5.7 [Use Transitions for Non-Urgent Updates](#57)
...
For subscription granularity of derived values, see [Subscribe to Derived State](#55). For refs holding callbacks used in effects, see [Store Event Handlers in Refs](#81).
...
### 5.3 Extract to Memoized Components
